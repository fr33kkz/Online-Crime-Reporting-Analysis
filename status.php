...
$cid = $_SESSION['cid'];
$result1=mysqli_query($con,"SELECT a_no FROM users where email='$email'");
...
$query = "select c_id,description,inc_status,pol_status from complaint natural join users where c_id='$cid' and email='$email'";
  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="index3.php">Log New Complain</a></li>
        <li><a href="history.php">Complaint History</a></li>
        <li class="active"><a href="status.php">Complaint Status</a></li>
